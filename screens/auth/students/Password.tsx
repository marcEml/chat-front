...
import { RegistrationData, RegistrationResponseData, ResponseError } from "@/helpers/apiInterface";
import moment from "moment";

const StudentPasswordScreen = (props: any) => {
  // VARIABLES
...
export default StudentPasswordScreen;

...
const StudentsClass = (props: any) => {
  const { theme } = useTheme();
  const styles = createHomeScreenStyles(theme.colors);
  const params = props.route.params;
  const [students, setStudents] = React.useState(params.class.students);
  ...
  return (
    <View style={styles.screenContainer}>
      ...
      >
        Retrouvez la liste de tous les étudiants inscrits à votre cours.
      </Text>

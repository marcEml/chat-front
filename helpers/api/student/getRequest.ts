...
const endpoint = urlMapping.student.getRequest;

const GetStudentClassRequests = async (): Promise<RequestData | ResponseError> => {
...
export default GetStudentClassRequests;
